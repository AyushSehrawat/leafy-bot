    ...
    async def help(self, ctx, choice=None):
        ...
        if choice is None:
            embed = discord.Embed(
                ...
                description=f"```Please choose any one```\n`{a}help general`\n`{a}help mod`\n`{a}help fun`\n`{a}help info`\n`{a}help music`\n`{a}help setup`\n`{a}help extra`\n",
                color=0xFF0000,
            )
            embed.set_author(
