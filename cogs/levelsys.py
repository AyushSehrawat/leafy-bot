...
class Levelsys(commands.Cog):
    ...
    @commands.command(
        aliases=['xp', 'r'],description='Shows your xp and global rank')
        ...
        if a == 0:
            ...
            if stats is None:
                ...
                embed = discord.Embed(
                    ...
                    title=f"{ctx.author.name}'s Level stats", color=0xff0000)
                embed.add_field(
                    name="Name", value=f"{ctx.author.mention}", inline=True)
                embed.add_field(
