...
unicode_list = [
    "\U0001f600", "\U0001f970", "\U0001f609", "\U0001f60a", "\U0001f971"
]
...
async def on_guild_join(guild):
	...
	try:
		...
		embed = discord.Embed(
		    title="Hello!",
		    description=
		    "Thanks for adding me to your server! I hope you like me <:rainblob:796632292503977995>! I got a new family :)",
		    color=0xff0000)
		embed.add_field(
		    name="Use --help to know more about me",
		    value=
		    "To get started use `--help` or `--help setup` to setup few things"
		)
...
async def on_message(msg):
    if msg.content == '<@791888515100573727>' or msg.content == '<@!791888515100573727>':
        ...
        embed.set_author(
            name=
            f"My prefix is `{pref}` and use `{pref}help` to see all commands",
